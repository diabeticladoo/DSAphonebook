...
int main()
{
     ...
     while (true)
     {
          ...
          case 6:
          {
               ...
               trieDelete(rootname, p[i].getname());
               deletedcontacts.push_back(i);
               break;
          }
          case 7:
          {
          ...
          {
               file.close();
               sort(deletedcontacts.begin(), deletedcontacts.end(), greater<int>());
               delcontact(deletedcontacts);
               cout << "Exiting\n";
               exit(0);
               break;
          }
